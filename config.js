...
const OWNER_FORMSPREE = 'https://formspree.io/f/mojblyqg'; // Reyhle's formspree

function formatPrice(price, type) { return `$${price}/${type}`; }
...
function productImg(p) {
  if (p.photo_url) return `<img src="${p.photo_url}" alt="${p.name}" style="width:100%;height:100%;object-fit:cover;">`;
  return `<div style="display:flex;align-items:center;justify-content:center;height:100%;font-size:3rem;background:linear-gradient(135deg,#f0f9ff,#e0f2fe);">📦</div>`;
}
  ...
  <nav>
    <div class="nav-left">
      <a href="index.html" class="logo">
        <span class="logo-shift">Shift</span><span class="logo-able">able</span><span class="logo-up">↑</span>
      </a>
...
.logo-shift{font-family:'Syne',sans-serif;font-size:1.6rem;font-weight:800;color:#fff;letter-spacing:-.02em;}
.logo-able{font-family:'Syne',sans-serif;font-size:1.6rem;font-weight:800;color:#38bdf8;letter-spacing:-.02em;}
.logo-up{font-size:1rem;color:#38bdf8;position:relative;top:-4px;margin-left:1px;}
